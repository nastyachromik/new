LEXICON: dict[str, str] = {'forward': '>>>',
                               ...
                               '/start': '<b>Привет, читатель!</b>\n\nЭто бот, в котором '
                                         'ты можешь прочитать книгу Ивана Тургенева "Муму"\n\n'
                               ...
                               'no_bookmarks': 'У вас пока нет ни одной закладки.\n\nЧтобы'
                                               ' добавить страницу в закладки - во время чтения книги нажмите на'
                                               ' кнопку с '
                                               'номером этой страницы\n\n/continue - продолжить чтение',
                               'cancel_text': '/continue - продолжить чтение',
                                'other_text': 'Я не понимаю ваше сообщение. Для списка команд используйте /help'
                               }
